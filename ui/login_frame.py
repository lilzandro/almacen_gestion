    ...
    def __init__(self, parent, on_login_success):
        ...
        if Image:
            try:
                ...
                ctk.CTkLabel(
                    card, text="📡", font=ctk.CTkFont(size=62), text_color="#084887"
                ).pack(pady=(40, 4))
        else:
            ctk.CTkLabel(
                card, text="📡", font=ctk.CTkFont(size=62), text_color="#084887"
        ...
        self.err_lbl = ctk.CTkLabel(
            card,
            text="",
            text_color="#F58A07",  # Acción / Resaltado
            font=ctk.CTkFont(size=14),
        )
...
class _ForceChangePasswordDialog(ctk.CTkToplevel):
    ...
    def __init__(self, parent, user: dict, on_done):
        ...
        ctk.CTkFrame(self, fg_color="#031D44", height=56).pack(fill="x")
        ctk.CTkLabel(self, text="🔒  Debes cambiar tu contraseña",
                     font=ctk.CTkFont(size=16, weight="bold"),
                     text_color="#031D44").pack(pady=(14, 2))
        ...
        def _entry(ph):
            return ctk.CTkEntry(self, width=300, height=42, show="•",
                                ...
                                fg_color="white", border_width=1, border_color="#084887",
                                text_color="#031D44")
        ...
        self._err = ctk.CTkLabel(self, text="", text_color="#FB8500",
